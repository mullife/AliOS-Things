...
{
  brd_led.port = NUCLEO_LED;
  brd_led.config = OUTPUT_PUSH_PULL;
  hal_gpio_init(&brd_led);

  brd_button.port = NUCLEO_BUTTON;
  brd_button.config = IRQ_MODE;
  hal_gpio_init(&brd_button);    
}
