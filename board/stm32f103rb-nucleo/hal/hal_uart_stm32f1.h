...
#define PORT_UART1 0           /* USART1 */
#define PORT_UART2 1           /* the port number of stand uart must be 0 */
...
#define UART1_PARITY                   UART_PARITY_ODD
...
#define UART1_RX_GPIO_CLK_DISABLE()    __HAL_RCC_GPIOA_CLK_DISABLE()
...
#define UART2_PARITY                   UART_PARITY_ODD
